...
condition = y_train == 1
y_train2 = pd.concat([y_train[condition]]*4)

y_train = pd.concat([y_train, y_train2], ignore_index=True)



X_train2 = pd.concat([X_train[condition]]*4)

X_train = pd.concat([X_train, X_train2], ignore_index=True)
...
plt.pause(0.1)
sns.violinplot(data=np.array(y_train))
